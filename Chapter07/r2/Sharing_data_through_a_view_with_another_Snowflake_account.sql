...
--populate customer address table
...
--provider account: create secure view joining data across databases
...
--grant usage on the secure view database and schema
...
--grant reference usage on the underlying databases
